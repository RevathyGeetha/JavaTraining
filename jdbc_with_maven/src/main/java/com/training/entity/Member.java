...
public class Member {
	...
	private LocalDate accountOpenType;
	...
	public Member(int memberId, String memberName, String memberAddress, LocalDate accountOpenType,
	...
	public LocalDate getAccountOpenType() {
		return accountOpenType;
	}
	public void setAccountOpenType(LocalDate accountOpenType) {
		this.accountOpenType = accountOpenType;
	}
	...
	public String toString() {
		return "Member [memberId=" + memberId + ", memberName=" + memberName + ", memberAddress=" + memberAddress
				+ ", accountOpenType=" + accountOpenType + ", memberShipType=" + memberShipType + ", feesPaid="
